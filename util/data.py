...
def dataframe_to_array(dfs: List[pd.DataFrame]):
    """ Converts any Pandas DataFrames or sparse matrices into NumPy arrays
    
        Args:
            dfs: A list of Pandas DataFrames or sparse matrices to be converted.
